...
// Api uses fetch to make requests to the backend
class Api {
  constructor({ baseUrl }) {
...
//headers are used to send the jwt and the content type
...
//ApiEntity is a class that represents an entity in the backend
class ApiEntity {
  constructor({ key, api }) {
    this.key = key;
    this.api = api;
